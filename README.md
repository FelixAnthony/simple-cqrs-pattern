# simple-cqrs-pattern
A simple nuget package to implement request dispatching from the Command Query Responsibility Segragation pattern in your asynchronous .Net Core workflow.
